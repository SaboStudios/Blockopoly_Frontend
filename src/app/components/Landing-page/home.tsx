...
export default function Home() {
  ...
  return (
    <section className="relative">
      <div>
          <Image src="/bg gradient.png" alt="bg-color" width={1440} height={1024} className="z-1 absolute top-0 border-2 border-red-600"/>
        ...
        <div className="w-[47.875rem] h-[14.75rem]">
          <div className="w-[47.875rem] h-[11.5rem]">
            ...
            <div className="relative">
              ...
              <h1 className="w-[47.875rem] font-[900] text-[7.25rem] font-[Orbitron] leading-[7.5rem] tracking-tight capitalize m-0">THE BLOCK</h1>
              <Link href="#">
                <Image src="/QuestionMark.png" 
                  alt="block-image" width={27} height={27} 
                  className="absolute top-[112.02px] left-[522.51px] pt-[0.83px]
                  pr-[5.8px] pb-[0.83px] pl-[5.8px] gap-[2.76px] rotate-[12 deg]"
                />
              </Link>
          ...
          <div className="w-[21.6875rem] h-[11.9375rem] mt-[2rem] border-2 border-red-500 mx-auto">
           <InputField />
