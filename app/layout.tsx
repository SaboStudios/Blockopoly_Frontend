...
export const metadata = getMetadata({
  title: "Blockopoly",
  description:
    "Blockopoly is a decentralized on-chain game inspired by the classic Monopoly, built on Starknet. Players buy, sell, and trade digital properties in a trustless gaming environment.",
})
