    ...
    return (
        <div className="w-full h-[685px] border-[1px] border-[#263238] flex flex-col mt-4 rounded-[12px]">
            ...
            <main className="w-full h-[calc(100%-89px)] overflow-y-auto no-scrollbar flex justify-center items-center">
                <p className="text-[#AFBAC0] text-center text-[14px] font-dmSan font-[500] truncate" title="No messages yet. Send a message below to start the conversation.">No messages yet. Send a message below to start the conversation.</p>
            </main>
