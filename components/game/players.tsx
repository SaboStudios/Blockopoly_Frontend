                ...
                <div className="w-full h-full flex flex-col gap-4 ">
                    ...
                    `}>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span title="Aji (Me)" className='text-[#F0F7F7] font-medium font-dmSans text-[16px] truncate'>Aji <span className='text-[10px]'>(Me)</span></span>
                        </div>
                    ...
                    `}>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span title="Signor" className='text-[#F0F7F7] font-medium font-dmSans text-[16px] truncate'>Signor </span>
                        </div>
                    </div>
                        ...
                        <div className="w-full p-[12px] bg-[#0B191A] rounded-[12px]">
                            <div className="bg-[#131F25] w-full flex flex-col items-center p-[12px] rounded-[8px] gap-4">
                                <p className='text-[#73838B] text-[11px] text-center'>
                                    <CircleAlert className='w-3 h-3 inline mr-1' />No trades yet. Create a trade to swap properties, cash, and bonus cards with other players.</p>
