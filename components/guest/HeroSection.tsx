...
const HERO_COPY = {
    ...
    heroDescription: 'Step into Blockopoly — the Web3 twist on the classic game of strategy, ownership, and fortune. Collect tokens, complete quests, and become the ultimate blockchain tycoon.',
}
    ...
    return (
        <section className="w-full lg:h-screen md:h-[calc(100vh-87px)] h-screen relative overflow-x-hidden md:mb-20 mb-10">
            ...
            <main className='w-full h-full absolute top-0 left-0 z-20 bg-transparent flex flex-col lg:justify-center items-center gap-1'>
                ...
                <p className="w-full px-4 md:w-[70%] lg:w-[55%] text-center font-[400] md:text-[18px] text-[14px] font-dmSans text-[#F0F7F7] -tracking-[2%]">{HERO_COPY.heroDescription}</p>
                ...
                <div className="w-full flex flex-col justify-center items-center mt-3 gap-3">
                    ...
                    <input type="text" name="name" id="name" value={gamerName}
                        onChange={handleInputChange} required placeholder={HERO_COPY.namePlaceholder} className='w-[80%] md:w-[260px] h-[45px] bg-[#0E1415] rounded-[12px] border-[1px] border-[#003B3E] outline-none px-3 text-[#17ffff] font-orbitron font-[400] text-[16px] text-center placeholder:text-[#455A64] placeholder:font-dmSans placeholder:text-[16px]' />
